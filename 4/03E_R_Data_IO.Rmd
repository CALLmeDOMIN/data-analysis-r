...
```{r}
# Your code here:
df <- data.frame(ID = 1:5, Name = c("John1", "John2", "John3", "John4", "John5"), Score = c(50, 100, 75, 55, 67))
export(df, "students.xlsx")
df_rio <- import("students.xlsx")
df_rio
```
...
df <- data.frame(Country = c("Poland", "Germany", "France", "Italy", "Spain"), Capital = c("Warsaw", "Berlin", "Paris", "Rome", "Madrid"), Population = c(38, 83, 67, 60, 47))

write_tsv(df, "countries.tsv")

df_read <- read_tsv("countries.tsv")
